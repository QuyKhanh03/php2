...
<!-- Mirrored from gymove.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 07:40:12 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon icon -->
	{{-- import css từ views/layout/main.blade.php --}}
            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="add-user">Form Add User</a></li>
                            <li><a href="add-discount">Form Add Discount</a></li>
                            <li><a href="add-product">Form Add Product</a></li>
                            <li><a href="add-category">Form Add Category</a></li>   
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="user">DataTable Users</a></li>
                            <li><a href="discount">DataTable Discounts</a></li>
                            <li><a href="product">DataTable Products</a></li>
                            <li><a href="category">DataTable Categories</a></li>
                            <li><a href="comment">DataTable Comments</a></li> 
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <div class="add-menu-sidebar">
                    <img src="public/images/calendar.png" alt="" class="mr-3">
